...
public class AsignaturaControlador {
	...
	public String recoveryDeUsuario(Model modelo, String email, String respuesta) {

		List<Usuario> usuariosExistentes = usuarioServicio.listarTodosLosUsuarios();
		
		Usuario usuario = usuarioServicio.encontrarUsuarioPorEmailYRespuesta(email, respuesta);
